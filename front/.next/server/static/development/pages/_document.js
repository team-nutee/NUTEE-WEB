...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_12___default.a {
  static getInitialProps(context) {
    const sheet = new styled_components__WEBPACK_IMPORTED_MODULE_13__["ServerStyleSheet"]();
  ...
  render() {
    const _this$props$helmet = this.props.helmet,
      ...
      bodyAttributes
          ...
          helmet = Object(_babel_runtime_corejs2_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_7__["default"])(_this$props$helmet, ["htmlAttributes", "bodyAttributes"]);

    const htmlAttrs = htmlAttributes.toComponent();
    const bodyAttrs = bodyAttributes.toComponent();
    return __jsx("html", htmlAttrs, __jsx("head", null, this.props.styleTags, _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_6___default()(helmet).map(el => el.toComponent())), __jsx("body", bodyAttrs, __jsx(next_document__WEBPACK_IMPORTED_MODULE_12__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_12__["NextScript"], null)));
  }
